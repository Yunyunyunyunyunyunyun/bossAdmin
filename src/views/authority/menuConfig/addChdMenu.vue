    ...
    <div class="mainAdd">
      ...
      >
        ...
        <el-form-item label="菜单类型：" prop="menuType">
          <el-radio-group v-if="mType === 0" v-model="menuForm.menuType">
            <el-radio :label="0">
              目录
            </el-radio>
            <el-radio :label="1">
          ...
          <el-radio-group v-if="mType === 1" v-model="menuForm.menuType">
            <el-radio :label="2">
              按钮
            </el-radio>
          </el-radio-group>
        ...
        <el-form-item v-if="mType === 1||menuForm.menuType==2" label="按钮标识：" prop="identifier">
    ...
    getMenuInfoList (params) {
      Server.showEditMenu(params).then((res) => {
        if (res.code === 0) {
          ...
          this.menuForm.parentMenu = this.menuInfoList.name
          this.menuForm.parentId = this.menuInfoList.id
          this.mType = this.menuInfoList.mType
          this.menuForm.menuType = this.mType === 0 ? 0 : this.mType === 1 ? 2 : ''
        }
      })
    },
    faIcon () {
